...
public class MutableBoolean implements Mutable, Serializable, Comparable {
	...
	// -----------------------------------------------------------------------
	/**
	 * Compares this object to the specified object. The result is <code>true</code> if and only if the argument is not <code>null</code> and is an <code>MutableBoolean</code> object that contains the same <code>boolean</code> value as this
	 * object.
	 * 
	 * @param obj
	 ...
	 * 
	 * @return the integer <code>1231</code> if this object represents <code>true</code>; returns the integer <code>1237</code> if this

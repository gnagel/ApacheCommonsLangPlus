...
public class MutableFloat extends Number implements Comparable, Mutable {
	...
	// -----------------------------------------------------------------------
	/**
	 * Compares this object against some other object. The result is <code>true</code> if and only if the argument is not <code>null</code> and is a <code>Float</code> object that represents a <code>float</code> that has the identical bit
	 * pattern to the bit pattern of the <code>float</code> represented by this object. For this purpose, two
	 * float values are considered to be the same if and only if the method {@link Float#floatToIntBits(float)}returns the same int value when
	 * applied to each.
	 * <p>
	 ...
	 * <li>If <code>f1</code> represents <code>+0.0f</code> while <code>f2</code> represents <code>-0.0f</code>, or vice versa, the <code>equal</code> test has the value <code>false</code>, even though <code>0.0f==-0.0f</code> has the value
	 * <code>true</code>.
	 * </ul>

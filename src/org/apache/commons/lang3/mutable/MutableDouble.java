...
public class MutableDouble extends Number implements Comparable, Mutable {
	...
	// -----------------------------------------------------------------------
	/**
	 * Compares this object against the specified object. The result is <code>true</code> if and only if the argument is not <code>null</code> and is a <code>Double</code> object that represents a double that has the
	 ...
	 * considered to be the same if and only if the method {@link Double#doubleToLongBits(double)}returns the same long value when
	 * applied to each.
	 * <p>
	 ...
	 * <li>If <code>d1</code> represents <code>+0.0</code> while <code>d2</code> represents <code>-0.0</code>, or vice versa, the <code>equal</code> test has the value <code>false</code>, even though <code>+0.0==-0.0</code> has the value
	 * <code>true</code>. This allows hashtables to operate properly.
	 * </ul>
	 * 
	 * @param obj
